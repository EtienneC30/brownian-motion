...
lemma IsSquareIntegrable.iSup_eLpNorm_eq_eLpNorm_limitProcess [CompleteSpace E] [IsFiniteMeasure P]
    [Nonempty ι] [OrderTopology ι] [SeparableSpace ι] (hX : IsSquareIntegrable X 𝓕 P) :
    ⨆ i, eLpNorm (X i) 2 P = eLpNorm (𝓕.limitProcess X P) 2 P := by
  refine le_antisymm
    (iSup_eLpNorm_le_eLpNorm_limitProcess hX.martingale hX.uniformIntegrable hX.isRightContinuous
      (by simp)) ?_
...
lemma IsSquareIntegrable.iSup_lintegral_pow_two_eq [CompleteSpace E] [IsFiniteMeasure P]
    [Nonempty ι] [OrderTopology ι] [SeparableSpace ι] (hX : IsSquareIntegrable X 𝓕 P) :
...
lemma IsAESquareIntegrable.iSup_eLpNorm_eq_eLpNorm_limitProcess
    [CompleteSpace E] [IsFiniteMeasure P]
    [Nonempty ι] [OrderTopology ι] [SeparableSpace ι] (hX : IsAESquareIntegrable X 𝓕 P) :
    ⨆ i, eLpNorm (X i) 2 P = eLpNorm (𝓕.limitProcess X P) 2 P := by
...
lemma IsSquareIntegrable.memLp_limitProcess [CompleteSpace E] [IsFiniteMeasure P]
    [Nonempty ι] [OrderTopology ι] [SeparableSpace ι] (hX : IsSquareIntegrable X 𝓕 P) :
...
lemma IsAESquareIntegrable.memLp_limitProcess [CompleteSpace E] [IsFiniteMeasure P]
    [Nonempty ι] [OrderTopology ι] [SeparableSpace ι] (hX : IsAESquareIntegrable X 𝓕 P) :
    MemLp (𝓕.limitProcess X P) 2 P := by
...
theorem IsSquareIntegrable.integral_iSup_norm_rpow_rpow_inv_le_limitProcess [CompleteSpace E]
    [IsFiniteMeasure P] [Nonempty ι] (hX : IsSquareIntegrable X 𝓕 P) :
...
theorem IsAESquareIntegrable.integral_iSup_norm_rpow_rpow_inv_le_limitProcess [CompleteSpace E]
    [IsFiniteMeasure P] [Nonempty ι] (hX : IsAESquareIntegrable X 𝓕 P) :
...
variable [OrderTopology ι] [SeparableSpace ι]
...
variable [InnerProductSpace ℝ E] [Nonempty ι] [OrderTopology ι] [SeparableSpace ι]
