...
Let $(X_s)_{s \in S}$ be a family of random variables and $(Y_t)_{t \in T}$ be a family of uniformly integrable random variables.. If for all $s$, there exists $t$ such that $\|X_t\| \le \|Y s\|$ almost surely, then $X$ is uniformly integrable.
\end{lemma}
...
\begin{proof}
  ...
  \ref{lem:nondecreasing_predictablePart_of_submartingale}
